...
export function useContactFilterContext() {
  ...
  const filterTypes = computed(() => [
    ...
    {
      attributeKey: CONTACT_ATTRIBUTES.ZIP_CODE,
      value: CONTACT_ATTRIBUTES.ZIP_CODE,
      attributeName: t('CONTACTS_LAYOUT.FILTER.ZIP_CODE'),
      label: t('CONTACTS_LAYOUT.FILTER.ZIP_CODE'),
      inputType: 'plainText',
      dataType: 'text',
      filterOperators: containmentOperators.value,
      attributeModel: 'standard',
    ...
    {
      attributeKey: CONTACT_ATTRIBUTES.ADDRESS,
      value: CONTACT_ATTRIBUTES.ADDRESS,
      attributeName: t('CONTACTS_LAYOUT.FILTER.ADDRESS'),
      label: t('CONTACTS_LAYOUT.FILTER.ADDRESS'),
      inputType: 'plainText',
      dataType: 'text',
      filterOperators: containmentOperators.value,
      attributeModel: 'standard',
    ...
    {
      attributeKey: CONTACT_ATTRIBUTES.ADDRESS_NUMBER,
      value: CONTACT_ATTRIBUTES.ADDRESS_NUMBER,
      attributeName: t('CONTACTS_LAYOUT.FILTER.ADDRESS_NUMBER'),
      label: t('CONTACTS_LAYOUT.FILTER.ADDRESS_NUMBER'),
      inputType: 'plainText',
      dataType: 'text',
      filterOperators: containmentOperators.value,
      attributeModel: 'standard',
